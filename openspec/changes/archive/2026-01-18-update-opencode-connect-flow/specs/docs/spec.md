...
- **WHEN** OpenCode setup is supported by the scripts
- **THEN** the README lists OpenCode as a supported target
...
- **AND THEN** the README reflects that OpenCode is listed first in tool selection menus
